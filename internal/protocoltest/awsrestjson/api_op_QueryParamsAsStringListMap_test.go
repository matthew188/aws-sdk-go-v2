...
func TestClient_QueryParamsAsStringListMap_awsRestjson1Serialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.QueryParamsAsStringListMap(context.Background(), c.Params)
			if err != nil {
