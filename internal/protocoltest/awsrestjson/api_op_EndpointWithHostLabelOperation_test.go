...
func TestClient_EndpointWithHostLabelOperation_awsRestjson1Serialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			if name == "RestJsonEndpointTraitWithHostLabel" {
				t.Skip("disabled test aws.protocoltests.restjson#RestJson aws.protocoltests.restjson#EndpointWithHostLabelOperation")
			}
			...
			result, err := client.EndpointWithHostLabelOperation(context.Background(), c.Params)
			if err != nil {
