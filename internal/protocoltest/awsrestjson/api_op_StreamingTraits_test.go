...
func TestClient_StreamingTraits_awsRestjson1Serialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.StreamingTraits(context.Background(), c.Params)
			if err != nil {
...
func TestClient_StreamingTraits_awsRestjson1Deserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.StreamingTraits(context.Background(), &params)
			if err != nil {
				t.Fatalf("expect nil err, got %v", err)
			}
			if result == nil {
