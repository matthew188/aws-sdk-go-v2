...
func TestClient_TestBodyStructure_awsRestjson1Serialize(t *testing.T) {
	cases := map[string]struct {
		...
		"RestJsonTestBodyStructure": {
			...
			BodyAssert: func(actual io.Reader) error {
				return smithytesting.CompareJSONReaderBytes(actual, []byte(`{"testConfig":
			    {"timeout": 10}
			}`))
			},
		},
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.TestBodyStructure(context.Background(), c.Params)
			if err != nil {
