...
func TestClient_HttpRequestWithRegexLiteral_awsRestjson1Serialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.HttpRequestWithRegexLiteral(context.Background(), c.Params)
			if err != nil {
