...
func TestClient_HttpPayloadTraitsWithMediaType_awsRestjson1Serialize(t *testing.T) {
	cases := map[string]struct {
		...
		"RestJsonHttpPayloadTraitsWithMediaTypeWithBlob": {
			...
			ExpectMethod:  "POST",
			ExpectURIPath: "/HttpPayloadTraitsWithMediaType",
			ExpectQuery:   []smithytesting.QueryItem{},
			ExpectHeader: http.Header{
...
func TestClient_HttpPayloadTraitsWithMediaType_awsRestjson1Deserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
