...
func TestClient_NestedStructures_awsAwsquerySerialize(t *testing.T) {
		...
		"NestedStructures": {
			Params: &NestedStructuresInput{
				Nested: &types.StructArg{
					StringArg: ptr.String("foo"),
					OtherArg:  ptr.Bool(true),
					RecursiveArg: &types.StructArg{
						StringArg: ptr.String("baz"),
					},
				},
			},
			ExpectMethod:  "POST",
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.NestedStructures(context.Background(), c.Params)
			if err != nil {
