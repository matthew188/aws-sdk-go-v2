...
func TestClient_EndpointWithHostLabelOperation_awsAwsquerySerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			if name == "AwsQueryEndpointTraitWithHostLabel" {
				t.Skip("disabled test aws.protocoltests.query#AwsQuery aws.protocoltests.query#EndpointWithHostLabelOperation")
			}
