...
func TestClient_EndpointWithHostLabelOperation_awsAwsjson11Serialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			if name == "AwsJson11EndpointTraitWithHostLabel" {
				t.Skip("disabled test aws.protocoltests.json#JsonProtocol aws.protocoltests.json#EndpointWithHostLabelOperation")
			}
