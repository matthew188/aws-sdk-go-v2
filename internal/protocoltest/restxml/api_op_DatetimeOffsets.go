...
func (c *Client) addOperationDatetimeOffsetsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	err = stack.Serialize.Add(&awsRestxml_serializeOpDatetimeOffsets{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsRestxml_deserializeOpDatetimeOffsets{}, middleware.After)
	if err != nil {
		return err
	}
