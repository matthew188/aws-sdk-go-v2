...
func TestClient_FlattenedXmlMapWithXmlName_awsRestxmlSerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"FlattenedXmlMapWithXmlName": {
			...
			ExpectMethod:  "POST",
			ExpectURIPath: "/FlattenedXmlMapWithXmlName",
			ExpectQuery:   []smithytesting.QueryItem{},
			ExpectHeader: http.Header{
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.FlattenedXmlMapWithXmlName(context.Background(), c.Params)
			if err != nil {
...
func TestClient_FlattenedXmlMapWithXmlName_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
