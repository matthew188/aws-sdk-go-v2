...
func TestClient_XmlEmptyLists_awsRestxmlSerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlEmptyLists(context.Background(), c.Params)
			if err != nil {
...
func TestClient_XmlEmptyLists_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
