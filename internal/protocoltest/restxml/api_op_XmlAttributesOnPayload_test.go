...
func TestClient_XmlAttributesOnPayload_awsRestxmlSerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"XmlAttributesOnPayload": {
			...
			ExpectMethod:  "PUT",
			ExpectURIPath: "/XmlAttributesOnPayload",
			ExpectQuery:   []smithytesting.QueryItem{},
			ExpectHeader: http.Header{
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlAttributesOnPayload(context.Background(), c.Params)
			if err != nil {
...
func TestClient_XmlAttributesOnPayload_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			var params XmlAttributesOnPayloadInput
			result, err := client.XmlAttributesOnPayload(context.Background(), &params)
			if err != nil {
				t.Fatalf("expect nil err, got %v", err)
			}
			if result == nil {
