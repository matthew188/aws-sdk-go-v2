...
func TestClient_XmlMaps_awsRestxmlSerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlMaps(context.Background(), c.Params)
			if err != nil {
...
func TestClient_XmlMaps_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
