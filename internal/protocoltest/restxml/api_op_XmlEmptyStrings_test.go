...
func TestClient_XmlEmptyStrings_awsRestxmlSerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlEmptyStrings(context.Background(), c.Params)
			if err != nil {
...
func TestClient_XmlEmptyStrings_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
