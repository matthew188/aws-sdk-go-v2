...
func TestClient_XmlIntEnums_awsRestxmlSerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlIntEnums(context.Background(), c.Params)
			if err != nil {
...
func TestClient_XmlIntEnums_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
