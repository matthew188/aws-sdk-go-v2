...
func TestClient_NoInputAndOutput_awsEc2querySerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"Ec2QueryNoInputAndOutput": {
			...
			BodyAssert: func(actual io.Reader) error {
				return smithytesting.CompareURLFormReaderBytes(actual, []byte(`Action=NoInputAndOutput&Version=2020-01-08`))
			},
		},
	}
...
func TestClient_NoInputAndOutput_awsEc2queryDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
		...
		"Ec2QueryNoInputAndOutput": {
			...
			Body: []byte(`<NoInputAndOutputResponse xmlns="https://example.com/">
