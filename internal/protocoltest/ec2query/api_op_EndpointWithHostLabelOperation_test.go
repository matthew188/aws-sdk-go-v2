...
func TestClient_EndpointWithHostLabelOperation_awsEc2querySerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			if name == "Ec2QueryEndpointTraitWithHostLabel" {
				t.Skip("disabled test aws.protocoltests.ec2#AwsEc2 aws.protocoltests.ec2#EndpointWithHostLabelOperation")
			}
