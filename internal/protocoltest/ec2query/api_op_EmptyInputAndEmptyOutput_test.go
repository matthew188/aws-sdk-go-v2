...
func TestClient_EmptyInputAndEmptyOutput_awsEc2querySerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"Ec2QueryEmptyInputAndEmptyOutput": {
			Params:        &EmptyInputAndEmptyOutputInput{},
			ExpectMethod:  "POST",
			ExpectURIPath: "/",
			ExpectQuery:   []smithytesting.QueryItem{},
			...
			BodyAssert: func(actual io.Reader) error {
				return smithytesting.CompareURLFormReaderBytes(actual, []byte(`Action=EmptyInputAndEmptyOutput&Version=2020-01-08`))
			},
		},
	}
...
func TestClient_EmptyInputAndEmptyOutput_awsEc2queryDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
