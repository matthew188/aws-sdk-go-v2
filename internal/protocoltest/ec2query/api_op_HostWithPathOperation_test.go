...
func TestClient_HostWithPathOperation_awsEc2querySerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"Ec2QueryHostWithPath": {
			...
			BodyAssert: func(actual io.Reader) error {
				return smithytesting.CompareReaderBytes(actual, []byte(`Action=HostWithPathOperation&Version=2020-01-08`))
			},
		},
	}
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.HostWithPathOperation(context.Background(), c.Params)
			if err != nil {
