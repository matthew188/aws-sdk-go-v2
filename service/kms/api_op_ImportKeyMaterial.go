...
type ImportKeyMaterialInput struct {
	...
	// value for the ValidTo parameter. When value is KEY_MATERIAL_DOES_NOT_EXPIRE, you
	// must omit the ValidTo parameter. You cannot change the ExpirationModel or
