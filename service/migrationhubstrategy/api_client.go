...
// Client provides the API client to make operations call for Migration Hub
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "migrationhubstrategy", goModuleVersion)(stack)
}
