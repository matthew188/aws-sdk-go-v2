...
// Client provides the API client to make operations call for AWS IoT Greengrass
// V2.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "greengrassv2", goModuleVersion)(stack)
}
