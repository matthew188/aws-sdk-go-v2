...
// worker portal is now supported in VPC and public internet. Use SourceIpConfig to
// restrict worker access to tasks to a specific range of IP addresses. You specify
// allowed IP addresses by creating a list of up to ten CIDRs
...
// your workforce. You can delete work teams using the operation. After restricting
