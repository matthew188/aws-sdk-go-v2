...
// position by using BiasPosition, or filter results within a bounding box by using
// FilterBBox. These parameters are mutually exclusive; using both BiasPosition and
