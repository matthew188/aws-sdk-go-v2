...
type CreateDeploymentInput struct {
	...
	// Allows you to specify information about alarms associated with a deployment. The
	// alarm configuration that you specify here will override the alarm configuration
	// at the deployment group level. Consider overriding the alarm configuration if
	// you have set up alarms at the deployment group level that are causing deployment
	// failures. In this case, you would call CreateDeployment to create a new
	// deployment that uses a previous application revision that is known to work, and
	// set its alarm configuration to turn off alarm polling. Turning off alarm polling
	// ensures that the new deployment proceeds without being blocked by the alarm that
	// was generated by the previous, failed, deployment. If you specify an
	// overrideAlarmConfiguration, you need the UpdateDeploymentGroup IAM permission
