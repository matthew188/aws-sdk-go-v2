...
const ServiceID = "AppConfigData"
const ServiceAPIVersion = "2021-11-11"

// Client provides the API client to make operations call for AWS AppConfig Data.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "appconfigdata", goModuleVersion)(stack)
}
