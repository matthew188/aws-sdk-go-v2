...
//
// * The
// SampleCount value of the statistic set is 1.
//
// * The Min and the Max values of
// the statistic set are equal.
//
// Percentile statistics are not available for
// metrics when any of the metric values are negative numbers. Amazon CloudWatch
// retains metric data as follows:
//
// * Data points with a period of less than 60
