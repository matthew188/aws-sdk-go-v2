...
type WorkspaceActiveWaiterOptions struct {
	...
	// to zero, WorkspaceActiveWaiter will use default max delay of 120 seconds. Note
...
// Wait calls the waiter function for WorkspaceActive waiter. The maxWaitDur is the
...
type WorkspaceDeletedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, WorkspaceDeletedWaiter will use default max delay of 120 seconds. Note
	// that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
