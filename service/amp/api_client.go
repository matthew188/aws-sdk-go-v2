...
// Client provides the API client to make operations call for Amazon Prometheus
// Service.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "amp", goModuleVersion)(stack)
}
