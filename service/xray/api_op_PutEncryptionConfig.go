...
type PutEncryptionConfigInput struct {
	...
	//
	// * Alias - The
	// name of the key. For example, alias/MyKey.
	//
	// * Key ID - The KMS key ID of the
	// key. For example, ae4aa6d49-a4d8-9df9-a475-4ff6d7898456. Amazon Web Services
	// X-Ray does not support asymmetric KMS keys.
	//
	// * ARN - The full Amazon Resource
	// Name of the key ID or alias. For example,
