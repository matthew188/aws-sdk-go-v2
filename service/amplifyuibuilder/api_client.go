...
// Client provides the API client to make operations call for AWS Amplify UI
// Builder.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "amplifyuibuilder", goModuleVersion)(stack)
}
