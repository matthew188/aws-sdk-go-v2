...
type CreateSchemaInput struct {
	...
	//
	// * NONE: No
	// compatibility mode applies. You can use this choice in development scenarios or
	// if you do not know the compatibility mode that you want to apply to schemas. Any
	// new version added will be accepted without undergoing a compatibility check.
	//
	// *
	...
	//
	// * BACKWARD:
	// This compatibility choice is recommended as it allows data receivers to read
	// both the current and one previous schema version. This means that for instance,
	// a new schema version cannot drop data fields or change the type of these fields,
	// so they can't be read by readers using the previous version.
	//
	// * BACKWARD_ALL:
	// This compatibility choice allows data receivers to read both the current and all
	// previous schema versions. You can use this choice when you need to delete fields
	// or add optional fields, and check compatibility against all previous schema
	// versions.
	//
	...
	// versions. You can use this choice when you need to add fields or delete optional
	...
	// producers of any new registered schema. You can use this choice when you need to
	// add fields or delete optional fields, and check compatibility against all
	...
	//
	// * FULL_ALL: This compatibility
	// choice allows data receivers to read data written by producers using all
	// previous schema versions. You can use this choice when you need to add or remove
	// optional fields, and check compatibility against all previous schema versions.
