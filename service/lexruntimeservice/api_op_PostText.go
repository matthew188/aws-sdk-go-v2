...
// conclusion statement does not require a response. Some messages require only a
// "yes" or "no" user response. In addition to the message, Amazon Lex provides
...
//
// In addition, Amazon Lex also returns your
// application-specific sessionAttributes. For more information, see Managing
