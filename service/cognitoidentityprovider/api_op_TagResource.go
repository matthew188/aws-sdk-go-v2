...
// Identity and Access Management policy, you can constrain permissions for user
// pools based on specific tags or tag values. You can use this action up to 5
// times per second, per account. A user pool can have as many as 50 tags.
