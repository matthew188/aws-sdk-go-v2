...
type AdminInitiateAuthOutput struct {
	...
	// sign-in. To set up SMS MFA, users will need help from an administrator to add a
	...
	// the USER_ID_FOR_SRP attribute is the user's actual username, not an alias (such
	// as email address or phone number), even if you specified an alias in your call
	// to AdminInitiateAuth. This happens because, in the AdminRespondToAuthChallenge
	// API ChallengeResponses, the USERNAME attribute can't be an alias.
