...
// job. The model packaging job is complete if the value of Status is SUCCEEDED. To
// deploy the component to the target device, use the component name and component
