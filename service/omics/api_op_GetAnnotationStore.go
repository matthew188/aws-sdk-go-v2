...
type AnnotationStoreCreatedWaiterOptions struct {
	...
	// to zero, AnnotationStoreCreatedWaiter will use default max delay of 600 seconds.
...
// Wait calls the waiter function for AnnotationStoreCreated waiter. The maxWaitDur
...
type AnnotationStoreDeletedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, AnnotationStoreDeletedWaiter will use default max delay of 600 seconds.
	// Note that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
// Wait calls the waiter function for AnnotationStoreDeleted waiter. The maxWaitDur
// is the maximum wait duration the waiter will wait. The maxWaitDur is required
// and must be greater than zero.
