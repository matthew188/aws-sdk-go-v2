...
type StudioReadyWaiterOptions struct {
	...
	// to zero, StudioReadyWaiter will use default max delay of 120 seconds. Note that
...
type StudioDeletedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, StudioDeletedWaiter will use default max delay of 120 seconds. Note
