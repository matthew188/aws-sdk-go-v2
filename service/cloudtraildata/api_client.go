...
const ServiceID = "CloudTrail Data"
const ServiceAPIVersion = "2021-08-11"

// Client provides the API client to make operations call for AWS CloudTrail Data
// Service.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "cloudtraildata", goModuleVersion)(stack)
}
