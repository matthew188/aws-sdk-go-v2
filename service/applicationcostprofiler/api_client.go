...
const ServiceID = "ApplicationCostProfiler"
const ServiceAPIVersion = "2020-09-10"

// Client provides the API client to make operations call for AWS Application Cost
// Profiler.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "applicationcostprofiler", goModuleVersion)(stack)
}
