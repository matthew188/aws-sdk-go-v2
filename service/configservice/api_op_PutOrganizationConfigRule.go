...
// rules, see List of Config Managed Rules
// (https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html).
// If you are adding an Config managed rule, you must specify the rule's identifier
// for the RuleIdentifier key. Config Custom Rules are rules that you create from
...
// to create an Lambda function in the management account or a delegated
...
// function. When you use PutOrganizationConfigRule to add a Custom Lambda rule to
// Config, you must specify the Amazon Resource Name (ARN) that Lambda assigns to
// the function. Prerequisite: Ensure you call EnableAllFeatures API to enable all
// features in an organization. Make sure to specify one of either
