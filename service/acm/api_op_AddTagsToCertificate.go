...
// key and an optional value. You specify the certificate on input by its Amazon
// Resource Name (ARN). You specify the tag by using a key-value pair. You can
// apply a tag to just one certificate if you want to identify a specific
...
// (https://docs.aws.amazon.com/acm/latest/userguide/tags.html). To remove one or
// more tags, use the RemoveTagsFromCertificate action. To view all of the tags
// that have been applied to the certificate, use the ListTagsForCertificate
// action.
