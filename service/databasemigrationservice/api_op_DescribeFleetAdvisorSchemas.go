...
type DescribeFleetAdvisorSchemasInput struct {
	...
	//
	// * complexity – The schema's
	// complexity, for example Simple.
	//
	// * database-id – The ID of the schema's
	// database.
	//
	...
	//
	// * database-engine – The name
	// of the schema database's engine.
	//
	// * original-schema-name – The name of the
	// schema's database's main schema.
	//
	// * schema-id – The ID of the schema, for
	// example 15.
	//
	// * schema-name – The name of the schema.
	//
	// * server-ip-address – The
	// IP address of the schema database's server.
	//
	// An example is:
