...
// D:\Users\%USERNAME%MMddyyTHHmmss%.NotMigrated. A new D:\Users\%USERNAME%\ folder
// is generated by the new OS. Certain files in the old user profile are moved to
// the new user profile. For available migration scenarios, details about what
