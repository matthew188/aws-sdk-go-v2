...
// SUSPENDED. This operation is asynchronous and returns before the WorkSpaces have
// been completely terminated. After a WorkSpace is terminated, the TERMINATED
