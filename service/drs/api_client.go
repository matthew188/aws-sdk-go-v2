...
// Client provides the API client to make operations call for Elastic Disaster
// Recovery Service.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "drs", goModuleVersion)(stack)
}
