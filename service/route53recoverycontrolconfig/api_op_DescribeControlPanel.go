...
type ControlPanelCreatedWaiterOptions struct {
	...
	// to zero, ControlPanelCreatedWaiter will use default max delay of 120 seconds.
...
// Wait calls the waiter function for ControlPanelCreated waiter. The maxWaitDur is
...
type ControlPanelDeletedWaiterOptions struct {
	...
	// MaxDelay is the maximum amount of time to delay between retries. If unset or set
	// to zero, ControlPanelDeletedWaiter will use default max delay of 120 seconds.
	// Note that MaxDelay must resolve to value greater than or equal to the MinDelay.
	MaxDelay time.Duration
...
// Wait calls the waiter function for ControlPanelDeleted waiter. The maxWaitDur is
// the maximum wait duration the waiter will wait. The maxWaitDur is required and
// must be greater than zero.
