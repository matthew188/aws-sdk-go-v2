...
type CreateAttendeeInput struct {
	...
	// on all media channels by default. You use the capabilities with a set of values
	// that control what the capabilities can do, such as SendReceive data. For more
