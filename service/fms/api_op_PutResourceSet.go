...
// Creates the resource set. An Firewall Manager resource set defines the resources
// to import into an Firewall Manager policy from another Amazon Web Services
// service.
