...
// with the BatchPutDocument API. The documents are deleted asynchronously. You can
// see the progress of the deletion by using Amazon Web Services CloudWatch. Any
// error messages related to the processing of the batch are sent to you CloudWatch
// log.
