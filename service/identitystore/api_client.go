...
// Client provides the API client to make operations call for AWS SSO Identity
// Store.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "identitystore", goModuleVersion)(stack)
}
