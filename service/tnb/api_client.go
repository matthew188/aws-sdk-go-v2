...
// Client provides the API client to make operations call for AWS Telco Network
// Builder.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "tnb", goModuleVersion)(stack)
}
