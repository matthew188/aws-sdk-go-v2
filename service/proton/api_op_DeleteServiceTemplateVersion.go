...
// template if it's not the Recommended version. Delete a Recommended minor version
// of the service template if no other minor versions of the service template
// exist. A minor version of a service template is a version that's backwards
// compatible.
