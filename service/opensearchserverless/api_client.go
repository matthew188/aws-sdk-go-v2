...
// Client provides the API client to make operations call for OpenSearch Service
// Serverless.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "opensearchserverless", goModuleVersion)(stack)
}
