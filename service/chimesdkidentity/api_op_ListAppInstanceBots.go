...
func (c *Client) ListAppInstanceBots(ctx context.Context, params *ListAppInstanceBotsInput, optFns ...func(*Options)) (*ListAppInstanceBotsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListAppInstanceBots", params, optFns, c.addOperationListAppInstanceBotsMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*ListAppInstanceBotsOutput)
...
func (c *Client) addOperationListAppInstanceBotsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListAppInstanceBots(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListAppInstanceBotsPaginator struct {
	options   ListAppInstanceBotsPaginatorOptions
	client    ListAppInstanceBotsAPIClient
	params    *ListAppInstanceBotsInput
	nextToken *string
	firstPage bool
}
...
func NewListAppInstanceBotsPaginator(client ListAppInstanceBotsAPIClient, params *ListAppInstanceBotsInput, optFns ...func(*ListAppInstanceBotsPaginatorOptions)) *ListAppInstanceBotsPaginator {
	...
	return &ListAppInstanceBotsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
