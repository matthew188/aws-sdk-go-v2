...
// of 50 records per page. If you provide a maxResults, the value must be between 1
// and 50. To get the next page results, provide the pagination token from the
// GetBatchImportJobsResponse as part of your request. A null pagination token
