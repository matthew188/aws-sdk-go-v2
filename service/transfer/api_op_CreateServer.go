...
type CreateServerInput struct {
	...
	// the Certificate Manager User Guide. To import an existing certificate into ACM,
	// see Importing certificates into ACM
	// (https://docs.aws.amazon.com/acm/latest/userguide/import-certificate.html) in
	// the Certificate Manager User Guide. To request a private certificate to use FTPS
	// through private IP addresses, see Request a private certificate
