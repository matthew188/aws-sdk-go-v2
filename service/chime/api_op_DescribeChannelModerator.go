...
func (m *endpointPrefix_opDescribeChannelModeratorMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opDescribeChannelModeratorMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opDescribeChannelModeratorMiddleware{}, `OperationSerializer`, middleware.After)
}
