...
func (m *endpointPrefix_opListChannelBansMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opListChannelBansMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opListChannelBansMiddleware{}, `OperationSerializer`, middleware.After)
}
