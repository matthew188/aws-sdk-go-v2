...
// account types, in the Amazon Chime Administration Guide. Previously suspended
// users who are unsuspended using this action are returned to Registered status.
