...
// information, items purchased, and vendor names. StartExpenseAnalysis can analyze
// text in documents that are in JPEG, PNG, and PDF format. The documents must be
// stored in an Amazon S3 bucket. Use the DocumentLocation parameter to specify the
// name of your S3 bucket and the name of the document in that bucket.
