...
// FaceModelVersion in the response from IndexFaces For more information, see Model
// Versioning in the Amazon Rekognition Developer Guide. If you provide the
...
// detected faces, specify NONE. To use quality filtering, you need a collection
// associated with version 3 of the face model or higher. To get the version of the
// face model associated with a collection, call DescribeCollection. Information
...
type IndexFacesInput struct {
	...
	// all faces that don’t meet the chosen quality bar. The default value is AUTO. The
	...
	// too extreme to use. If you specify NONE, no filtering is performed. To use
