...
// Resources (https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html). This
// operation requires permissions to perform the rekognition:TagResource action.
