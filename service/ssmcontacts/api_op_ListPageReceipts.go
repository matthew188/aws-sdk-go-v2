...
func (c *Client) ListPageReceipts(ctx context.Context, params *ListPageReceiptsInput, optFns ...func(*Options)) (*ListPageReceiptsOutput, error) {
	...
	out := result.(*ListPageReceiptsOutput)
...
func (c *Client) addOperationListPageReceiptsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListPageReceipts(options.Region), middleware.Before); err != nil {
		return err
	}
...
type ListPageReceiptsPaginator struct {
	options   ListPageReceiptsPaginatorOptions
	client    ListPageReceiptsAPIClient
	params    *ListPageReceiptsInput
	nextToken *string
	firstPage bool
}
...
func NewListPageReceiptsPaginator(client ListPageReceiptsAPIClient, params *ListPageReceiptsInput, optFns ...func(*ListPageReceiptsPaginatorOptions)) *ListPageReceiptsPaginator {
	...
	return &ListPageReceiptsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
