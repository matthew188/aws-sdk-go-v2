...
func (c *Client) addOperationListContactChannelsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Deserialize.Add(&awsAwsjson11_deserializeOpListContactChannels{}, middleware.After)
	if err != nil {
		return err
	}
	...
	if err = addOpListContactChannelsValidationMiddleware(stack); err != nil {
		return err
	}
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListContactChannels(options.Region), middleware.Before); err != nil {
		return err
	}
...
var _ ListContactChannelsAPIClient = (*Client)(nil)

// ListContactChannelsPaginatorOptions is the paginator options for
// ListContactChannels
type ListContactChannelsPaginatorOptions struct {
	// The maximum number of contact channels per page.
	Limit int32
...
type ListContactChannelsPaginator struct {
	options   ListContactChannelsPaginatorOptions
	client    ListContactChannelsAPIClient
	params    *ListContactChannelsInput
	nextToken *string
	firstPage bool
}
...
func NewListContactChannelsPaginator(client ListContactChannelsAPIClient, params *ListContactChannelsInput, optFns ...func(*ListContactChannelsPaginatorOptions)) *ListContactChannelsPaginator {
	...
	return &ListContactChannelsPaginator{
		options:   options,
		client:    client,
		params:    params,
		firstPage: true,
...
func (p *ListContactChannelsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListContactChannelsOutput, error) {
	...
	result, err := p.client.ListContactChannels(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
...
func newServiceMetadataMiddleware_opListContactChannels(region string) *awsmiddleware.RegisterServiceMetadata {
