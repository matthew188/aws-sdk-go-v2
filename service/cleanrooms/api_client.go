...
// Client provides the API client to make operations call for AWS Clean Rooms
// Service.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "cleanrooms", goModuleVersion)(stack)
}
