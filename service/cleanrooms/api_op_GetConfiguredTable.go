...
func (c *Client) addOperationGetConfiguredTableMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opGetConfiguredTable(options.Region), middleware.Before); err != nil {
		return err
	}
...
func newServiceMetadataMiddleware_opGetConfiguredTable(region string) *awsmiddleware.RegisterServiceMetadata {
