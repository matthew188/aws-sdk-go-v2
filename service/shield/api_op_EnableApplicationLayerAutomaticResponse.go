...
import (
	...
	"github.com/matthew188/aws-sdk-go-v2/service/shield/types"
...
// UpdateApplicationLayerAutomaticResponse. To use this feature, you must associate
// a web ACL with the protected resource. The web ACL must be created using the
// latest version of WAF (v2). You can associate the web ACL through the Shield
// Advanced console at https://console.aws.amazon.com/wafv2/shieldv2#/
