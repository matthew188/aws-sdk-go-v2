...
type ExecuteProvisionedProductServiceActionInput struct {
	...
	// the default value generated by Service Catalog. If the parameters field is not
	// provided, no additional parameters are passed and default values will be used
	// for any special parameters such as TARGET.
