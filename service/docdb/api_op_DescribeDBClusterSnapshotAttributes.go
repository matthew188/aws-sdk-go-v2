...
// or restore the manual cluster snapshot. If all is included in the list of values
// for the restore attribute, then the manual cluster snapshot is public and can be
