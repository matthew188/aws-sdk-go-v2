...
// topic. The ARN is displayed in the Amazon SNS console. You can specify the type
// of source (SourceType) that you want to be notified of. You can also provide a
// list of Amazon DocumentDB sources (SourceIds) that trigger the events, and you
// can provide a list of event categories (EventCategories) for events that you
