...
// endpoints by updating an endpoint group by using the UpdateEndpointGroup
...
// doesn't need to resolve any endpoints. With the UpdateEndpointGroup API
// operation, Global Accelerator must resolve all of the endpoints that remain in
// the group.
