...
//
// * It's
// faster, because Global Accelerator only has to resolve the new endpoints that
// you're adding.
//
// * It's more convenient, because you don't need to specify all of
// the current endpoints that are already in the endpoint group in addition to the
