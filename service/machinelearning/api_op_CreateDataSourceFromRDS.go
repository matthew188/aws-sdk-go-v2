...
type CreateDataSourceFromRDSInput struct {
	...
	//
	// * DatabaseCredentials -
	// AWS Identity and Access Management (IAM) credentials that are used to connect to
	// the Amazon RDS database.
	//
	// * ResourceRole - A role
	// (DataPipelineDefaultResourceRole) assumed by an EC2 instance to carry out the
	// copy task from Amazon RDS to Amazon Simple Storage Service (Amazon S3). For more
	// information, see Role templates
	// (https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html)
	// for data pipelines.
	//
	// * ServiceRole - A role (DataPipelineDefaultRole) assumed by
	// the AWS Data Pipeline service to monitor the progress of the copy task from
	// Amazon RDS to Amazon S3. For more information, see Role templates
	// (https://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html)
	// for data pipelines.
	//
	// * SecurityInfo - The security information to use to access
	// an RDS DB instance. You need to set up appropriate ingress rules for the
	...
	// data. The data retrieved from Amazon RDS using SelectSqlQuery is stored in this
	// location.
	//
	...
	//
	// * DataRearrangement - A JSON string that represents
	// the splitting and rearrangement requirements for the Datasource. Sample -
