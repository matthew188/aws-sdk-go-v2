...
func (c *Client) ListOrganizations(ctx context.Context, params *ListOrganizationsInput, optFns ...func(*Options)) (*ListOrganizationsOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "ListOrganizations", params, optFns, c.addOperationListOrganizationsMiddlewares)
	if err != nil {
		return nil, err
	}
...
func (c *Client) addOperationListOrganizationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware_opListOrganizations(options.Region), middleware.Before); err != nil {
		return err
	}
...
// ListOrganizationsAPIClient is a client that implements the ListOrganizations
// operation.
...
var _ ListOrganizationsAPIClient = (*Client)(nil)
...
func (p *ListOrganizationsPaginator) NextPage(ctx context.Context, optFns ...func(*Options)) (*ListOrganizationsOutput, error) {
	...
	result, err := p.client.ListOrganizations(ctx, &params, optFns...)
	if err != nil {
		return nil, err
	}
	p.firstPage = false
