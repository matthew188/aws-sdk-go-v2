...
func (c *Client) DescribeFeedback(ctx context.Context, params *DescribeFeedbackInput, optFns ...func(*Options)) (*DescribeFeedbackOutput, error) {
	...
	result, metadata, err := c.invokeOperation(ctx, "DescribeFeedback", params, optFns, c.addOperationDescribeFeedbackMiddlewares)
	if err != nil {
		return nil, err
	}

	out := result.(*DescribeFeedbackOutput)
...
func newServiceMetadataMiddleware_opDescribeFeedback(region string) *awsmiddleware.RegisterServiceMetadata {
