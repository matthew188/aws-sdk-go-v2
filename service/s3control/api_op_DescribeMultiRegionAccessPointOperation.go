...
func (m *endpointPrefix_opDescribeMultiRegionAccessPointOperationMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addEndpointPrefix_opDescribeMultiRegionAccessPointOperationMiddleware(stack *middleware.Stack) error {
	return stack.Serialize.Insert(&endpointPrefix_opDescribeMultiRegionAccessPointOperationMiddleware{}, `OperationSerializer`, middleware.After)
}
