...
// the Amazon Web Services account that owns the Outposts bucket, the calling
// identity must have the PutBucketPolicy permissions on the specified Outposts
// bucket and belong to the bucket owner's account in order to use this action. If
// you don't have PutBucketPolicy permissions, Amazon S3 returns a 403 Access
