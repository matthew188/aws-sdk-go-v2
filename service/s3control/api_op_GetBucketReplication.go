...
// permissions for the s3-outposts:GetReplicationConfiguration action. The Outposts
...
// Managing access to S3 on Outposts bucket
...
// replication failure reasons, see Replication failure reasons
