...
// Client provides the API client to make operations call for AWS ARC - Zonal
// Shift.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "arczonalshift", goModuleVersion)(stack)
}
