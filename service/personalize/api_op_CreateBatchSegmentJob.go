...
// batch recommendations and user segments
...
type CreateBatchSegmentJobInput struct {
	...
	// The ARN of the filter to apply to the batch segment job. For more information on
	// using filters, see Filtering batch recommendations
