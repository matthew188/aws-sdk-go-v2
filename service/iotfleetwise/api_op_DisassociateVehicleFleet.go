...
// a fleet doesn't delete the vehicle. If the vehicle is successfully dissociated
// from a fleet, Amazon Web Services IoT FleetWise sends back an HTTP 200 response
// with an empty body.
