...
// a handshake. Handshakes that are ACCEPTED, DECLINED, CANCELED, or EXPIRED appear
// in the results of this API for only 30 days after changing to that state. After
