...
// SAML roles that can be assumed via AssumeDecoratedRoleWithSAML must at a minimum
// include lakeformation:GetDataAccess in their role policies. A typical IAM policy
