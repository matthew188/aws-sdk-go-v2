...
//
// * PENDING_CERTIFICATE - The certificate is
// pending. You must use your Amazon Web Services Private CA-hosted or on-premises
// root or subordinate CA to sign your private CA CSR and then import it into
...
//
// * DELETED - Your private CA is within the restoration
// period, after which it is permanently deleted. The length of time remaining in
// the CA's restoration period is also included in this action's output.
