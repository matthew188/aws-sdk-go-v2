...
// changes to applied in subsequent GetInstance or GetInstances API calls. For more
// information, see Use IMDSv2 with an Amazon Lightsail instance
...
type UpdateInstanceMetadataOptionsInput struct {
	...
	// number means that the instance metadata requests can travel farther. If no
