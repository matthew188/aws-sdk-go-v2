...
// Client provides the API client to make operations call for AWS Snow Device
// Management.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "snowdevicemanagement", goModuleVersion)(stack)
}
