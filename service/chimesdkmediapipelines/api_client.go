...
// Client provides the API client to make operations call for Amazon Chime SDK
// Media Pipelines.
type Client struct {
	options Options
}
...
func addClientUserAgent(stack *middleware.Stack) error {
	return awsmiddleware.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "chimesdkmediapipelines", goModuleVersion)(stack)
}
